...
Enemy_2Bullet::Enemy_2Bullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Defense* parent) :
    Bullet("play/bullet-6.png", 500, 2.5, position, forwardDirection, rotation, parent) {
}
