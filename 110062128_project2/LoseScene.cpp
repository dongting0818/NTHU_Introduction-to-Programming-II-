...
void LoseScene::Initialize() {
	...
	int halfW = w / 2;
	int halfH = h / 2;
	AddNewObject(new Engine::Image("play/lose.png", halfW, halfH, 0, 0, 0.5, 0.5));
    ...
    bgmInstance = AudioHelper::PlaySample("WOW.ogg", false, AudioHelper::BGMVolume, PlayScene::DangerTime);
}
